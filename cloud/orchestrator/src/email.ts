// Email sending via Resend. We hit the API directly with fetch so the Worker
// doesn't pull in the Node-flavored Resend SDK (which has compatibility
// rough edges in workerd) — Resend's REST surface is tiny and stable.
//
